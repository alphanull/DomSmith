...
export default class DomSmith {
     ...
     * @param {HTMLElement|module:DomSmith~Options}                                    [options]  Either a target HTMLElement or an options object.
     */
     ...
     * @param  {HTMLElement|HTMLElement|module:DomSmith~Options} [options]  Either a target HTMLElement or an options object.
    ...
    addNode(nodeDefArg, parent) {
         ...
         * @param   {module:DomSmith~NodeDefinition} nd  The definition to parse.
     ...
     * @param   {module:DomSmith~NodeDefinition|module:DomSmith~NodeDefinition[]} [nodeDefArg=this._dom]  The node definition(s) from which to remove events.
     * @returns {module:DomSmith~NodeDefinition|module:DomSmith~NodeDefinition[]}                         The - possibly modified - node definition(s).
     */
 ...
 * @property {module:DomSmith~NodeDefinition[]}     [_nodes]   Child node definitions; can be a single NodeDefinition, a string, or an array of them.
 * @property {*}                                    [any]      Additional properties that will be assigned either directly or via setAttribute.
 */

/**
 * @typedef {Object} module:DomSmith~Options
