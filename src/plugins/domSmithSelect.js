/**
 * DomSmith plugin that just takes all `<select>` and wraps them in a `.select-wrapper` DIV container.
 * @module plugins/domSmithSelect
 ...
 * @param   {module:DomSmith~NodeDefinition}           nodeDef  The original node definition object.
 * @returns {module:DomSmith~NodeDefinition|undefined}          The patched nodeDef or undefined.
 */
